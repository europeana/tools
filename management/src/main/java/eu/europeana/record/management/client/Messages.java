...
/**
 * The messages of the components of the UI of the application
 * 
...
public class Messages {
	...
	public final static String LASTLOGIN = "Last Login";
	public final static String MODIFY = "Modify Account";
	public final static String LOGIN = "Login";
	public final static String SAVE = "Save";
	public final static String MANAGERECORDS = "Manage Europeana Records";
	public final static String LOGSFORUSER = "Select Logs for User";
