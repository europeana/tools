...
public class Family {
    ...
    private List<Node> followingSiblings = new ArrayList<>();
    private List<Node> precedingSiblings = new ArrayList<>();
    private List<Node> followingSiblingChildren = new ArrayList<>();
    private List<Node> precedingSiblingChildren = new ArrayList<>();
