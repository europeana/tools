...
public class MigrationUtils {
    ...
    public ProxyImpl addValueToProxy(EntityWrapper wrapper, ProxyImpl europeanaProxy) {
        ...
        if (StringUtils.equals(wrapper.getOriginalField(), "proxy_dcterms_issued")) {
            europeanaProxy.setDctermsIssued(addToMap(europeanaProxy.getDctermsIssued(), wrapper.getUrl()));
        }
        if (StringUtils.equals(wrapper.getOriginalField(), "proxy_dcterms_created")) {
            europeanaProxy.setDctermsCreated(addToMap(europeanaProxy.getDctermsCreated(), wrapper.getUrl()));
        }
        if (StringUtils.equals(wrapper.getOriginalField(), "proxy_dcterms_temporal")) {
            europeanaProxy.setDctermsTemporal(addToMap(europeanaProxy.getDctermsTemporal(), wrapper.getUrl()));
        }
        ...
        if (StringUtils.equals(wrapper.getOriginalField(), "proxy_dcterms_spatial")) {
            europeanaProxy.setDctermsSpatial(addToMap(europeanaProxy.getDctermsSpatial(), wrapper.getUrl()));
        }
        ...
        if (StringUtils.equals(wrapper.getOriginalField(), "proxy_dc_contributor")) {
            europeanaProxy.setDcContributor(addToMap(europeanaProxy.getDcContributor(), wrapper.getUrl()));
        }
