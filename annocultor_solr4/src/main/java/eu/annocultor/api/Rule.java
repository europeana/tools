...
public abstract class Rule
{
	 ...
	 * 
	 */
	public abstract void fire(Triple triple, DataObject dataObject) throws Exception;

	protected boolean initialized = false;
	protected void init() throws Exception
	{
		// should be overridden in final rules... and checked there, in the xml api generated code
	}
	/**
	 * For analyzing the rule base the rules are grouped into groups:
	 * rename-property, domain-specific, etc. May be ignored if you are not going
	 * to develop any science on top of your rules.
	 * 
	 */
	...
	/**
	 * In invoked before a call to {@linkplain Rule#onInvocation(Triple, DataObject)} and allows to
	 * prevent rule from firing.
	 *  
	 * @param sourceTriple
	 * @param sourceDataObject
	 * @return
	 * @throws Exception
	 */
	public boolean onPreCondition(Triple sourceTriple, DataObject sourceDataObject) 
	throws Exception
	{
		return true;
	}
