...
public class Factory {
	 ...
	 * @return
	 */
	public static ConverterKernel makeConverter(Task task,
	...
	public static Graph makeLocalAnnotationsTarget(Task task, String... comment) {
		return CoreFactory.makeGraph(task, "annotations", "local", true, false,
				comment);
	}
	...
	public static Graph makeExtAnnotationsTarget(Task task, String... comment) {
		return CoreFactory.makeGraph(task, "annotations", "external", true,
				false, comment);
	}
	...
	public static Graph makeDescriptionsGraph(Task task, String... comment) {
		return CoreFactory.makeGraph(task, "descriptions", "", true, false,
				comment);
	}
	...
	public static Graph makeGraph(Task task, String objectType,
		...
		return CoreFactory.makeGraph(task, objectType, propertyType, true,
				false, comment);
	}
