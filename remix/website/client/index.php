...
if ($language != 'en' && $language != 'de') {
	...
	if ( isset( $_SERVER['HTTP_ACCEPT_LANGUAGE'] )
		...
		foreach ($matches as $match) {
			...
			$score = isset($match[5]) ? (float)($match[5]) : 1.0;
			if ($score > $best_score) {
				$language = $lang;
				$best_score = $score;
			}
...
<body>
	...
	<div id="container">
		<div id="video-frame" role="main">
			...
			<a href="#about" id="logo-link"><img id="eu-logo" src="image/logo.png" alt="eu-logo" class="fade"/></a>
			...
			<div id="intro" class="page intro">
				...
				<div id="intro-play"><img src="image/ajax-loader.gif" alt="loading..."/></div>
			...
			<div id="about" class="page">
				<div class="page-container">
					<section lang="en">
						...
						<h4>Europeana Foundation (<a href="http://www.europeana.eu" target="_blank">www.europeana.eu</a>)</h4>
						...
						<h4>Knowledgeland Foundation (<a href="http://www.knowledgeland.org" target="_blank">www.knowledgeland.org</a>)</h4>
...
<h4>Henryk Gajewski (<a href="http://gajewski.tv/" target="_blank">gajewski.tv</a>)</h4>
<p>Henryk Gajewski is an independent media production professional and film director. Henryk received many illustrious prizes and honours for his work.</p>

						<h4>Three Eyed Labs / Brian Chirls (<a href="http://www.chirls.com" target="_blank">www.chirls.com</a>)</h4>
						...
						<h4>BigUp / Harold van Velsen (<a href="http://werk.bigup.nl" target="_blank">werk.bigup.nl</a>)</h4>
						...
						<img src="http://mirrors.creativecommons.org/presskit/buttons/88x31/png/by-sa.png" alt="creative-commons">
					...
					<section lang="de">
						...
						<h4>Knowledgeland Foundation [Stiftung] (<a href="http://www.knowledgeland.org" target="_blank">www.knowledgeland.org</a>)</h4>
...
<h4>Henryk Gajewski (<a href="http://gajewski.tv">gajewski.tv</a>)</h4>
<p>Henryk Gajewski ist ein selbstständiger Media-Produktion-Professional und Filmdirektor. Henryk hat viele hohe Auszeichnungen und diverse Preise empfangen für seine sehr geschätzten Werke.</p>
			...
			<div id="contact" class="page">
				<div class="page-container">
					<section lang="en">
						...
						<p><a href="http://blog.europeana.eu" target="_blank">http://blog.europeana.eu</a></p>
					</section>
					<section lang="de">
						<h2>Kontakt</h2>
			...
			<div id="share-controls" class="control-group fade" style="display: none">
				<div id="twitter-button" class="control button flat">Twitter<img src="image/share-twitter.png" alt="Twitter"/></div>
				<div id="facebook-button" class="control button flat">Facebook<img src="image/share-facebook.png" alt="Facebook"/></div>
			</div>
			...
			<div id="bottom-controls" class="fade" style="opacity: 0">
				...
				<div id="comment-controls" class="control-group" style="float: left">
					<div id="add-comment-button" class="control button"><img src="image/comments.png" alt="comments" width="18" height="18"/></div>
				</div>
				<div id="main-controls" class="control-group">
					<div id="play-button" class="control button" style="float: left;">&nbsp;</div>
					<div id="settings-button" class="control button" style="float: right;"><img src="image/settings.png" width="18" height="18" alt="settings"/></div>
					<div id="volume-button" class="control button" style="float: right;"><img src="image/volume.png" width="46" height="48" alt="volume"/></div>
		...
		-->
			...
			<a href="http://www.europeana.eu" target="_blank"><img src="image/poweredby.png" alt="powered by"/></a>
		</footer>
