...
def pofile(fpath, **kwargs):
    ...
    **Example**:
    ...
    parser = _POFileParser(
        ...
        encoding=enc,
        check_for_duplicates=kwargs.get('check_for_duplicates', False),
        use_fuzzy=kwargs.get('use_fuzzy', True),
    )
...
class _BaseFile(list):
    ...
    def __init__(self, *args, **kwargs):
        ...
        **Keyword arguments**:
        ...
        self.use_fuzzy = kwargs.get('use_fuzzy', True)
        # header
        self.header = ''
        ...
        for e in self:
            if not self.use_fuzzy:
                if ('fuzzy' in e.flags):
                    ...
                    if e.msgid:
                        e.msgstr = u'' # clear translation
            if e.translated():
                r.append(e)
        return r  #[e for e in self if e.translated()]
...
class POEntry(_BaseEntry):
    ...
    **Examples**:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if u'python-format' in self.flags:
            print u'python-format found!'
            pass
...
class _POFileParser(object):
    ...
    def handle_fl(self):
        ...
        if self.current_entry.flags != [u'fuzzy']: 
            pass
        return True
