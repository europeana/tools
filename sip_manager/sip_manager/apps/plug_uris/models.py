...
class Uri(models.Model):
    ...
    """
    mdr_pk = models.IntegerField(db_index=True)
...
class ReqStats(models.Model):
    req_id = models.IntegerField(unique=True)
    ...
    ratio_2 = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)
    ...
    ratio_3 = models.DecimalField(max_digits=5, decimal_places=2, default=0.00)
