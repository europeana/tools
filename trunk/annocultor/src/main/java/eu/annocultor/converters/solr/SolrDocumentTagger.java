...
public abstract class SolrDocumentTagger {
    ...
    CommonsHttpSolrServer solrServerFrom;
    StreamingUpdateSolrServer solrServerTo;
    int start;
    ...
    public SolrDocumentTagger(
        ...
        this.query = query;
        this.solrServerFrom = new CommonsHttpSolrServer(solrServerFrom);
        this.solrServerTo =  new StreamingUpdateSolrServer(solrServerTo,100000,5);
    ...
    public abstract void tagDocument(SolrInputDocument document) throws Exception;
