...
import eu.annocultor.tagger.vocabularies.loaders.*;
...
implements GeneratedConverterInt {
        ...
        public void init() throws Exception {
          ...
          loadTermsSPARQL(
            ...
            new VocabularyLoader(
                environment.getVocabularyDir().getCanonicalPath()
            , "thesauri.rdf"
            )
          );
      ...
      null
        ...
        public void init() throws Exception {
          ...
          loadTermsSPARQL(
            ...
            environment.getTmpDir(),
            new MavenVocabularyLoader(
                "org.semium.vocabularies.time" ,
                "1.0.1"
            , "*.rdf"
            )
          );
          ...
          loadTermPropertiesSPARQL("begin",
            "PREFIX time: <http://semium.org/time/>    "
 ...
 + "  }",
      ...
      // Vocabulary general terminology based on GEMET and DBPEDIA
      ...
      null
        ...
        public void init() throws Exception {
          ...
          loadTermsSPARQL(
            ...
            environment.getTmpDir(),
            new MavenVocabularyLoader(
                "org.semium.vocabularies.concepts" ,
                "1.0.1"
            , "*.rdf"
            )
          );
...
//    	    System.out.println(">terms query>" + label);
      ...
      // Vocabulary directory of people based on DBPedia
      ...
      null
        ...
        public void init() throws Exception {
          ...
          loadTermsSPARQL(
            ...
            environment.getTmpDir(),
            new MavenVocabularyLoader(
                "org.semium.vocabularies.agents" ,
                "1.0.1"
            , "*.rdf"
            )
          );
      ...
      null
        ...
        public void init() throws Exception {
          ...
          loadTermsSPARQL(
            ...
            environment.getTmpDir(),
            new MavenVocabularyLoader(
                "org.semium.vocabularies.places" ,
                "1.0.1"
