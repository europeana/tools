...
try:
    ...
    raise exceptions.ImproperlyConfigured('Missing setting DEBUG - see sample_local_settings.py')
try:
    DATABASES
except:
    raise exceptions.ImproperlyConfigured('Missing setting DATABASES - see sample_local_settings.py')
try:
    SECRET_KEY
except:
    raise exceptions.ImproperlyConfigured('Missing setting SECRET_KEY - see sample_local_settings.py')
